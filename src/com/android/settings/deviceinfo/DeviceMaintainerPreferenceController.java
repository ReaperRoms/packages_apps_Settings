...
public class DeviceMaintainerPreferenceController extends PreferenceController {
    ...
    private static final String PROPERTY_DEVICE_MAINTAINER = "ro.reaper.maintainer";
    ...
    public boolean isAvailable() {
        return !TextUtils.isEmpty(SystemProperties.get(PROPERTY_DEVICE_MAINTAINER));
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (pref != null) {
            final String summary = SystemProperties.get(PROPERTY_DEVICE_MAINTAINER,
                    mContext.getResources().getString(R.string.device_maintainer_default));
